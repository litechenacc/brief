...
export function activate(context: vscode.ExtensionContext): void {
	...
	context.subscriptions.push(
		...
		command("brief.selectPrimeTheme", () => panels.selectPrimeTheme()),
		...
		command("brief.increaseFontSize", () => panels.adjustFontSize(1)),
		command("brief.decreaseFontSize", () => panels.adjustFontSize(-1)),
